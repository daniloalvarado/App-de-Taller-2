export const planta = {
  ...
  fields: [
    ...
    { name: 'tipo_inflorescencia', title: 'Tipo de Inflorescencia', type: 'string' },
    { name: 'tipo_fruto', title: 'Tipo de Fruto', type: 'string' },
    { name: 'tipo_infrutescencia', title: 'Tipo de Infrutescencia', type: 'string', description: 'Ej: Racimo, Espiga, Umbela, etc.' },
