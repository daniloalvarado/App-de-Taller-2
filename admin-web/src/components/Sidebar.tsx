...
export function Sidebar() {
    ...
    <div className="flex flex-col h-full bg-sidebar-background border-r border-sidebar-border">
      ...
      <div className="border-t border-sidebar-border p-3 space-y-2">
        ...
        <button
          ...
          className={cn(
            "flex items-center rounded-lg text-sm text-muted-foreground hover:bg-red-500/10 hover:text-white transition-colors cursor-pointer",
  ...
  return (
    <>
      {/* Desktop Sidebar */}
      <aside className={cn(
        'hidden md:flex flex-col h-screen sticky top-0 transition-all duration-300 z-40 isolation-auto',
        collapsed ? 'w-16' : 'w-60'
      )}>
        <SidebarContent />
      </aside>
